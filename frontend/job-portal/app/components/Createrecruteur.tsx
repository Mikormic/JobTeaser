...
function Createrecruteur() {
    ...
    const submit = async (e: any) => {
        e.preventDefault()
        try {
            await axios.post('http://localhost:3001/createRecruteurs', {
                email,
                password,
                titre,
                localisation
    ...
    return (
        <div>
            <button onClick={open} data-modal-target="crud-modal" data-modal-toggle="crud-modal" type='button' className='btn-jobs-footer bg-greenSite text-orangeSite font-bold hover:bg-beigeSite' >Create Recruteur</button>
...
export default Createrecruteur